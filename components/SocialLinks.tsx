        ...
        {socialLinks.map((link) => (
          <li key={link.name}>
            <a
              ...
              className="flex items-center justify-center gap-4 p-6 md:p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50"
              tabIndex={0}
